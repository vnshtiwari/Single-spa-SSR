...
app.use("*", (req, res, next) => {
  ...
  const importMapsPromise = getImportMaps({
    url: "http://localhost:8080/dist/importmap.json",
    ...
    if (developmentMode) {
      ...
      browserImportMap.imports["@isomorphic-mf/footer"] =
        "http://localhost:8080/dist/isomorphic-mf-footer.js";
      browserImportMap.imports["@isomorphic-mf/footer/"] =
        "http://localhost:8080/dist/";

      // browserImportMap.imports["@isomorphic-mf/header"] =
      //   "http://localhost:8081/dist/isomorphic-mf-header.js";
      // browserImportMap.imports["@isomorphic-mf/header/"] =
      //   "http://localhost:8081/dist/";

      browserImportMap.imports["@isomorphic-mf/product"] =
        "http://localhost:8082/dist/isomorphic-mf-product.js";
      browserImportMap.imports["@isomorphic-mf/product/"] =
        "http://localhost:8082/dist/";

      browserImportMap.imports["@isomorphic-mf/home"] =
        "http://localhost:8083/dist/isomorphic-mf-home.js";
      browserImportMap.imports["@isomorphic-mf/home/"] =
        "http://localhost:8083/dist/";
    }
